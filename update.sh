...
sudo echo "###### $(date) Performing Update ######" | sudo tee ${LOG_FILE}
...
sudo echo "### Deploying updater playbook" | sudo tee ${LOG_FILE}
cd sensor
ansible-playbook main.yml

sudo echo "###### $(date) Completed Update ######" | sudo tee ${LOG_FILE}
